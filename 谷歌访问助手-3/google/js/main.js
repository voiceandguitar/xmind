...
if(("#mzk_about_us").length > 0) {
    lang_init();
    $("#mzk_server_police").click(function(){
        chrome.tabs.create({url:"https://mzke.com/page/service"});
    });
    
    $("#mzk_privacy_police").click(function(){
        chrome.tabs.create({url:"https://mzke.com/page/privacy"});
    });
}
